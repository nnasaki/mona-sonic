...
A playable Godot 4 coastal speed stage, made entirely with local code, procedural meshes, shaders, synthesized audio and locally installed fonts. No downloads, online assets, packages or network services are needed.
